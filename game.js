...
let players=[],slime,score=[0,0],timeLeft=75,running=false,last=0,message='',messageLife=0,shake=0,freeze=0,particles=[],chiefLine='',chiefLife=0,chiefThink=0,portalTime=0,goalScene=null;
